...
@section('title','Gsm Request Actived')

@section('card_title','Gsm Request Actived')
...
<br><br><br>
                  ...
                  <table id="table_display_request_actived" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          <th scope="col">No</th>
                          <th scope="col">GSM Number</th>
                          <th scope="col">Receipt Date</th>
                          <th scope="col">Active Request Date</th>
            ...
            <h5 class="modal-title" ><b>TERMINATED</b></h5>
              ...
              @csrf
                ...
                <label for="termination_date_request"> Termination Date Request</label>
                  <input name="termination_date_request" type="date" class="form-control" id="termination_date_request">
                </div>
                <div class="form-group">
...
$(document).ready(function () {
 ...
 //script untuk memanggil data json dari server dan menampilkannya berupa datatable
  ...
  table = $('#table_display_request_actived').DataTable({
      processing: true,
      serverSide: true,
      ajax: '{{url("/DRA/getdata")}}',
      columns: [
          {
              data: 'DT_RowIndex',
              name: 'DT_RowIndex'
