...
@section('title','GSM Actived')

@section('card_title','GSM Active')
...
<br><br><br>
                  ...
                  <table id="table_display_gsm_actived" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          <th scope="col">No</th>
                          <th scope="col">GSM Number</th>
                          <th scope="col">Receipt Date</th>
                          <th scope="col">Activation Request Date</th>
...
$(document).ready(function () {
 ...
 //script untuk memanggil data json dari server dan menampilkannya berupa datatable
  ...
  table = $('#table_display_gsm_actived').DataTable({
      processing: true,
      serverSide: true,
      ajax: '{{url("/DGA/getdata")}}',
      columns: [
          {
              data: 'DT_RowIndex',
              name: 'DT_RowIndex'
