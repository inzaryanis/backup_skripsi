...
@section('title','GSM Request Terminate')

@section('card_title','GSM Request Terminate')
...
<br><br><br>
                  ...
                  <table id="table_display_request_terminated" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          <th scope="col">No</th>
                          ...
                          <th scope="col">Terinated Remarks</th>
