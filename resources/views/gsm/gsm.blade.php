...
<br><br><br>
                  ...
                  <table id="table_gsm" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          <th scope="col">No</th>
            ...
            <h5 class="modal-title" >Issued</h5>
              ...
              @csrf
                ...
                <div class="form-group">
                  ...
                  <select id="gsm_number_issued" name="gsm_number_issued[]" multiple class="form-control" required>
                  @foreach ($gsm as $gsm)                                
            ...
            <h5 class="modal-title" ><b>TERMINATED</b></h5>
              ...
              @csrf
                ...
                <label for=" terminated_date"> Terminated Date</label>
                  <input name=" terminated_date" type="date" class="form-control" id=" terminated_date">
                </div>
                <div class="container">
                <div class="form-group">
...
table = $('#table_gsm').DataTable({
      processing: true,
      serverSide: true,
      ajax: '{{url("/gsm/getdata")}}',
      columns: [
          {
              data: 'DT_RowIndex',
              name: 'DT_RowIndex'
          ...
          // {
          //     data: 'activation_date_request',
          //     name: 'activation_date_request'
          // },
          // {
  ...
  //============================================================== moda request terminated =====================================================

  table = $('#table_display_request_terminated').DataTable({
      processing: true,
      serverSide: true,
      ajax: '{{url("/DRT/getdata")}}',
      columns: [
          {
              data: 'DT_RowIndex',
              name: 'DT_RowIndex'
...
$.get("gsm-detail/"+id+"/", function (data) {
  ...
  $('#Dcompany').html(data.customer);       // berdasarkan relasi tabel utama
  $('#Dnomor_polisi').html(data.nomor_polisi);
  $('#Dketerangan').html(data.keterangan);
